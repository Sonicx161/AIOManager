# Deploying AIOManager v1.5.8

AIOManager v1.5.8 requires a Node.js server to handle **Autopilot**, **Health Checks**, and **Sync**. 
...
## 3. Manual Deployment Guide - v1.5.9 (Node.js)
