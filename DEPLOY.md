# Deploying AIOManager v1.6.5

AIOManager v1.6.5 requires a Node.js server to handle **Autopilot**, **Health Checks**, and **Sync**. 
...
## 3. Manual Deployment Guide - v1.6.5 (Node.js)
