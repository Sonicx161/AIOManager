# Deploying AIOManager v1.6.4

AIOManager v1.6.4 requires a Node.js server to handle **Autopilot**, **Health Checks**, and **Sync**. 
...
## 3. Manual Deployment Guide - v1.6.4 (Node.js)
