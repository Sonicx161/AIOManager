              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <ol className="list-decimal list-inside space-y-2 text-sm ml-2">
                  ...
                  <li>Paste this code and press Enter:
                    <pre className="mt-2 text-xs bg-muted p-3 rounded-md overflow-x-auto font-mono text-muted-foreground border border-border select-all whitespace-pre-wrap break-all">
